...
class HelmBackend(Backend, BaseYAMLBackend):
    ...
    def compile(self, program: n.Program, *, cli_vars=None, **kwargs) -> CompileResult:
        ...
        files[f"{chart}/templates/_helpers.tpl"] = self._helpers_tpl(chart)
        ...
        files[f"{chart}/templates/deployment.yaml"] = tpl.get("deployment", "")
        files[f"{chart}/templates/statefulset.yaml"] = tpl.get("statefulset", "")
        files[f"{chart}/templates/service.yaml"] = tpl.get("service", "")
        files[f"{chart}/templates/secret.yaml"] = tpl.get("secret", "")
        files[f"{chart}/templates/configmap.yaml"] = tpl.get("configmap", "")
