...
from infra.backends.base import Backend, CompileResult
...
class TerraformBackend(Backend):
    ...
    def compile(self, program: n.Program, *, cli_vars=None, **kwargs) -> CompileResult:
        ...
        result.files["providers.tf"] = (
            "# Generated by Infra Language - DO NOT EDIT\n" + provider_conf
        )
        result.files["variables.tf"] = (
            "# Generated by Infra Language - DO NOT EDIT\n"
            + "\n".join(variables)
            + "\n"
        )
        result.files["outputs.tf"] = (
            "# Generated by Infra Language - DO NOT EDIT\n" + "\n".join(outputs) + "\n"
        )
        ...
        result.files["terraform.tfvars.example"] = (
            "# Generated by Infra Language - DO NOT EDIT\n" + self._tfvars_example()
        )
        return result
