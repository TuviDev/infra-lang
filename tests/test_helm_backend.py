...
def _yaml(content: str):
    return yaml.safe_load(content.replace("# Generated by Infra Language - DO NOT EDIT\n", "", 1))
...
class TestMoreStructure:
    def test_values_header_present(self):
        assert _chart_files(SERVICE_SRC)["values.yaml"].startswith("# Generated by Infra Language")

    def test_chart_yaml_header(self):
        assert _chart_files(SERVICE_SRC)["Chart.yaml"].startswith("# Generated by Infra Language")
